...
uid, starttime, endtime, duration, created painting, viewed gallery, paintingpath
...
class AnalyticsExt:
	...
	header = "uid,starttime,endtime,duration"
	...
	def AddSession(self, uid, startitme, endtime):
		"""
		...
		try:
			with open(self.outfilepath, 'a+', encoding='utf-8') as outfile:
				...
				session = f"{int(uid)},{self.datetimeToStr(startitme)},{self.datetimeToStr(endtime)},{dur}\n"
